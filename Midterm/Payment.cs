...
namespace Midterm
{
    class Payment
    {
        ...
        public void DisplayReceipt(List<Product> cart, Cash userPayment)
        {
            ...
            Console.WriteLine(userPayment.AmountGiven);
            Console.WriteLine(userPayment.Change);
        }
        ...
        public Payment ValidatePaymentType()
        {
            bool valid = false;
